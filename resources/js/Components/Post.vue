...
<template>
    <list-item class="hover:bg-gray-50">
        <div class="flex-wrap mb-2">
            <div>
                <div class="flex row">
                    ...
                    <span class="text-sm text-gray-500 italic">Posted {{relativeDate(post.created_at)}} ago</span>
                </div>
                <p class="mt-5 text-2xl font-bold">{{post.title}}</p>
                <p class="mt-4 break-words">{{post.body}}</p>
            </div>
